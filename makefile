...
ALL_SDL_INCLUDE=$(SDL_INCLUDE) $(SDL_mixer_INCLUDE) $(PATH_TO_SDL_devel)
...
ALL_SDL_INCLUDE=$(SDL_INCLUDE) $(SDL_mixer_INCLUDE)
...
INCLUDE_OPTIONS=-I$(GAMBIT_INCLUDE) -I$(GL_INCLUDE) -I$(ALL_SDL_INCLUDE)
endif
