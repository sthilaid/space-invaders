...
(define (render-object obj)
  ...
  (case type
    ...
    ((laserP) (render-fontified-sprite 'laserP x y state color))
    ((explodeI) (render-fontified-sprite 'explodeI x y state color))
    ((explodeInvL) (render-fontified-sprite 'explodeInvL x y state color))
    ((explodeS) (render-fontified-sprite 'explodeS x y state color))
    ((explodeP) (render-fontified-sprite 'explodeP x y state color))
